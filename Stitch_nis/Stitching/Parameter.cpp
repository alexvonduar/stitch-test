...
Parameter::Parameter(const string & _file_name) {
    ...
    file_dir = "C:/git/NISwGSP/Stitch_nis/x64/Debug/input-42-data/" + _file_name + "/";
    result_dir = "C:/git/NISwGSP/Stitch_nis/x64/Debug/input-42-data/0_results/" + _file_name + "-result/";
    
    _mkdir("C:/git/NISwGSP/Stitch_nis/x64/Debug/input-42-data/0_results/");
    mkdir(result_dir.c_str());
#ifndef NDEBUG
    debug_dir = "C:/git/NISwGSP/Stitch_nis/x64/Debug/input-42-data/1_debugs/" + _file_name + "-result/";
    mkdir("C:/git/NISwGSP/Stitch_nis/x64/Debug/input-42-data/1_debugs/");
